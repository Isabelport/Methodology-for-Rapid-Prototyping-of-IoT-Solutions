...
void setup()
{
  ...
  // Draw the icons
  tft.pushImage(100, 100, upWidth, upHeight, up);
  tft.pushImage(140, 100, downWidth, downHeight, down);
  tft.pushImage(180, 100, equalWidth, equalHeight, equal);
...
void loop()
{
  ...
  delay(100);
  /*
  tft.pushImage(random(tft.width() -  upWidth), random(tft.height() -  upHeight),  upWidth,  upHeight, up);
  tft.pushImage(random(tft.width() - downWidth), random(tft.height() - downHeight), downWidth, downHeight, down);
  tft.pushImage(random(tft.width() - equalWidth), random(tft.height() - equalHeight), equalWidth, equalHeight, equal);
